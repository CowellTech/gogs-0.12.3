LDFLAGS += -X "github.com/CowellTech/gogs-0.12.3/internal/conf.BuildTime=$(shell date -u '+%Y-%m-%d %I:%M:%S %Z')"
LDFLAGS += -X "github.com/CowellTech/gogs-0.12.3/internal/conf.BuildCommit=$(shell git rev-parse HEAD)"
